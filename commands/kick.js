...
module.exports.run = async (client,message,args) => {
 ...
 if(!message.member.hasPermission("KICK_MEMBERS") && message.author.id !== "139213278571134977")return message.reply("You have to have the `KICK_MEMBERS` permission to use this command");
